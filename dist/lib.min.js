...
(function(){var b={}.toString,e,d,a="function"===typeof define&&define.amd,c="object"==typeof exports&&exports,f='{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}',g,h,j,r,l,s,t,p,q,w,x,B,i,A,m=new Date(-0xc782b5b800cec),u,C,y;try{m=-109252==m.getUTCFullYear()&&0===m.getUTCMonth()&&1==m.getUTCDate()&&10==m.getUTCHours()&&37==m.getUTCMinutes()&&6==m.getUTCSeconds()&&708==m.getUTCMilliseconds()}catch(D){}m||(u=Math.floor,C=[0,31,59,90,120,151,181,212,243,273,304,334],y=function(a,c){return C[c]+365*
(a-1970)+u((a-1969+(c=+(1<c)))/4)-u((a-1901+c)/100)+u((a-1601+c)/400)});a||c?(a&&define("json",c={}),"object"==typeof JSON&&JSON&&(c.stringify=JSON.stringify,c.parse=JSON.parse)):c=this.JSON||(this.JSON={});if(a="function"==typeof c.stringify&&!y){(m=function(){return 1}).toJSON=m;try{a="0"===c.stringify(0)&&"0"===c.stringify(new Number)&&'""'==c.stringify(new String)&&void 0===c.stringify(b)&&void 0===c.stringify(void 0)&&void 0===c.stringify()&&"1"===c.stringify(m)&&"[1]"==c.stringify([m])&&"[null]"==
c.stringify([void 0])&&"null"==c.stringify(null)&&"[null,null,null]"==c.stringify([void 0,b,null])&&c.stringify({result:[m,!0,!1,null,"\x00\b\n\f\r\t"]})==f&&"1"===c.stringify(null,m)&&"[\n 1,\n 2\n]"==c.stringify([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==c.stringify(new Date(-864E13))&&'"+275760-09-13T00:00:00.000Z"'==c.stringify(new Date(864E13))&&'"-000001-01-01T00:00:00.000Z"'==c.stringify(new Date(-621987552E5))&&'"1969-12-31T23:59:59.999Z"'==c.stringify(new Date(-1))}catch(E){a=!1}}if("function"==
typeof c.parse)try{if(0===c.parse("0")&&!c.parse(!1)&&(m=c.parse(f),l=5==m.A.length&&1==m.A[0])){try{l=!c.parse('"\t"')}catch(F){}if(l)try{l=1!=c.parse("01")}catch(G){}}}catch(H){l=!1}m=f=null;if(!a||!l){if(!(e={}.hasOwnProperty))e=function(a){var c={},f;(c.__proto__=null,c.__proto__={toString:1},c).toString!=b?e=function(a){var c=this.__proto__,a=a in(this.__proto__=null,this);this.__proto__=c;return a}:(f=c.constructor,e=function(a){var c=(this.constructor||f).prototype;return a in this&&!(a in
c&&this[a]===c[a])});c=null;return e.call(this,a)};d=function(a,c){var f=0,d,g,h;(d=function(){this.valueOf=0}).prototype.valueOf=0;g=new d;for(h in g)e.call(g,h)&&f++;d=g=null;f?f=2==f?function(a,c){var f={},g="[object Function]"==b.call(a),d;for(d in a)!(g&&"prototype"==d)&&(!e.call(f,d)&&(f[d]=1)&&e.call(a,d))&&c(d)}:function(a,c){var f="[object Function]"==b.call(a),d,g;for(d in a)!(f&&"prototype"==d)&&(e.call(a,d)&&!(g="constructor"===d))&&c(d);(g||e.call(a,d="constructor"))&&c(d)}:(g="valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "),
f=function(a,c){var f="[object Function]"==b.call(a),d;for(d in a)!(f&&"prototype"==d)&&e.call(a,d)&&c(d);for(f=g.length;d=g[--f];e.call(a,d)&&c(d));});return f(a,c)};a||(g={"\\":"\\\\",'"':'\\"',"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t"},h=function(a,c){return("000000"+(c||0)).slice(-a)},j=function(a){for(var c='"',b=0,f;f=a.charAt(b);b++)c+=-1<'\\"\b\f\n\r\t'.indexOf(f)?g[f]:" ">f?"\\u00"+h(2,f.charCodeAt(0).toString(16)):f;return c+'"'},r=function(a,c,f,g,i,v,p){var k=c[a],n,l,q,m,
w,x,s,z,t;if("object"==typeof k&&k)if(n=b.call(k),"[object Date]"==n&&!e.call(k,"toJSON"))if(k>-1/0&&k<1/0){if(y){q=u(k/864E5);for(n=u(q/365.2425)+1970-1;y(n+1,0)<=q;n++);for(l=u((q-y(n,0))/30.42);y(n,l+1)<=q;l++);q=1+q-y(n,l);m=(k%864E5+864E5)%864E5;w=u(m/36E5)%24;x=u(m/6E4)%60;s=u(m/1E3)%60;m%=1E3}else n=k.getUTCFullYear(),l=k.getUTCMonth(),q=k.getUTCDate(),w=k.getUTCHours(),x=k.getUTCMinutes(),s=k.getUTCSeconds(),m=k.getUTCMilliseconds();k=(0>=n||1E4<=n?(0>n?"-":"+")+h(6,0>n?-n:n):h(4,n))+"-"+
h(2,l+1)+"-"+h(2,q)+"T"+h(2,w)+":"+h(2,x)+":"+h(2,s)+"."+h(3,m)+"Z"}else k=null;else if("function"==typeof k.toJSON&&("[object Number]"!=n&&"[object String]"!=n&&"[object Array]"!=n||e.call(k,"toJSON")))k=k.toJSON(a);f&&(k=f.call(c,a,k));if(null===k)return"null";n=b.call(k);if("[object Boolean]"==n)return""+k;if("[object Number]"==n)return k>-1/0&&k<1/0?""+k:"null";if("[object String]"==n)return j(k);if("object"==typeof k){for(a=p.length;a--;)if(p[a]===k)throw TypeError();p.push(k);z=[];c=v;v+=i;
if("[object Array]"==n){l=0;for(a=k.length;l<a;t||(t=!0),l++)n=r(l,k,f,g,i,v,p),z.push(void 0===n?"null":n);return t?i?"[\n"+v+z.join(",\n"+v)+"\n"+c+"]":"["+z.join(",")+"]":"[]"}d(g||k,function(a){var c=r(a,k,f,g,i,v,p);void 0!==c&&z.push(j(a)+":"+(i?" ":"")+c);t||(t=!0)});return t?i?"{\n"+v+z.join(",\n"+v)+"\n"+c+"}":"{"+z.join(",")+"}":"{}"}},c.stringify=function(a,c,f){var d,g,e,h,i,j;if("function"==typeof c||"object"==typeof c&&c)if("[object Function]"==b.call(c))g=c;else if("[object Array]"==
b.call(c)){e={};h=0;for(i=c.length;h<i;j=c[h++],("[object String]"==b.call(j)||"[object Number]"==b.call(j))&&(e[j]=1));}if(f)if("[object Number]"==b.call(f)){if(0<(f-=f%1)){d="";for(10<f&&(f=10);d.length<f;d+=" ");}}else"[object String]"==b.call(f)&&(d=10>=f.length?f:f.slice(0,10));return r("",(j={},j[""]=a,j),g,e,d,"",[])});l||(s=String.fromCharCode,t={"\\":"\\",'"':'"',"/":"/",b:"\b",t:"\t",n:"\n",f:"\f",r:"\r"},p=function(){i=A=null;throw SyntaxError();},q=function(){for(var a=A,c=a.length,b,
f,d,g,e;i<c;)if(b=a.charAt(i),-1<"\t\r\n ".indexOf(b))i++;else{if(-1<"{}[]:,".indexOf(b))return i++,b;if('"'==b){f="@";for(i++;i<c;)if(b=a.charAt(i)," ">b)p();else if("\\"==b)if(b=a.charAt(++i),-1<'\\"/btnfr'.indexOf(b))f+=t[b],i++;else if("u"==b){d=++i;for(g=i+4;i<g;i++)b=a.charAt(i),"0"<=b&&"9">=b||("a"<=b&&"f">=b||"A"<=b&&"F">=b)||p();f+=s("0x"+a.slice(d,i))}else p();else{if('"'==b)break;f+=b;i++}if('"'==a.charAt(i))return i++,f}else{d=i;"-"==b&&(e=!0,b=a.charAt(++i));if("0"<=b&&"9">=b){for("0"==
b&&(b=a.charAt(i+1),"0"<=b&&"9">=b)&&p();i<c&&(b=a.charAt(i),"0"<=b&&"9">=b);i++);if("."==a.charAt(i)){for(g=++i;g<c&&(b=a.charAt(g),"0"<=b&&"9">=b);g++);g==i&&p();i=g}b=a.charAt(i);if("e"==b||"E"==b){b=a.charAt(++i);("+"==b||"-"==b)&&i++;for(g=i;g<c&&(b=a.charAt(g),"0"<=b&&"9">=b);g++);g==i&&p();i=g}return+a.slice(d,i)}e&&p();if("true"==a.slice(i,i+4))return i+=4,!0;if("false"==a.slice(i,i+5))return i+=5,!1;if("null"==a.slice(i,i+4))return i+=4,null}p()}return"$"},w=function(a){var c,b;"$"==a&&p();
if("string"==typeof a){if("@"==a.charAt(0))return a.slice(1);if("["==a){for(c=[];;b||(b=!0)){a=q();if("]"==a)break;b&&(","==a?(a=q(),"]"==a&&p()):p());","==a&&p();c.push(w(a))}return c}if("{"==a){for(c={};;b||(b=!0)){a=q();if("}"==a)break;b&&(","==a?(a=q(),"}"==a&&p()):p());(","==a||"string"!=typeof a||"@"!=a.charAt(0)||":"!=q())&&p();c[a.slice(1)]=w(q())}return c}p()}return a},B=function(a,c,b){b=x(a,c,b);void 0===b?delete a[c]:a[c]=b},x=function(a,c,f){var g=a[c],e;if("object"==typeof g&&g)if("[object Array]"==
b.call(g))for(e=g.length;e--;)B(g,e,f);else d(g,function(a){B(g,a,f)});return f.call(a,c,g)},c.parse=function(a,c){i=0;A=a;var f=w(q());"$"!=q()&&p();i=A=null;return c&&"[object Function]"==b.call(c)?x((m={},m[""]=f,m),"",c):f})}}).call(lib);
...
(function(b){b.dimensions={get:function(b){var d,a;d=this.scroll();if("undefined"===typeof b)return b=this.layoutViewport(),{innerWidth:b.width,innerHeight:b.height,scrollX:d.x,scrollY:d.y};if(b)return a=b.getBoundingClientRect(),{width:a.width||b.offsetWidth,height:a.height||b.offsetHeight,left:a.left+d.x,top:a.top+d.y,right:a.right+d.x,bottom:a.bottom+d.y}},padding:function(b){return this.getPropertyDimensions(b,"padding-{0}")},border:function(b){return this.getPropertyDimensions(b,"border-{0}-width")},
margin:function(b){return this.getPropertyDimensions(b,"margin-{0}")},getPropertyDimensions:function(e,d){var a,c,f,g,h;f=["left","top","right","bottom"];h={};a=0;for(c=f.length;a<c;a++)g=f[a],h[g]=parseInt(b.dom.getStyle(e,b.string.format(d,[g])),10);return h},layoutViewport:function(){return{width:b.document.documentElement.clientWidth||document.body.clientWidth,height:b.document.documentElement.clientHeight||document.body.clientHeight}},visualViewport:function(){return{width:b.window.innerWidth||
document.documentElement.offsetWidth,height:b.window.innerHeight||document.documentElement.offsetHeight}},scroll:function(){return{x:b.window.scrollX||b.document.documentElement.scrollLeft,y:b.window.scrollY||b.document.documentElement.scrollTop}}}})(lib);if(!window.opera)try{document.execCommand("BackgroundImageCache",!1,!0)}catch(e$$13){}
(function(b){var e,d;e=["ms","moz","webkit","o"];d=0;b.tween={Bezier:function(a,b,d,e){var h=3*a,j=3*(d-a)-h,r=1-h-j,l=3*b,s=3*(e-b)-l,t=1-l-s;return function(a){for(var b=a,c=0,d;5>c;){d=b*(h+b*(j+b*r))-a;if(0.001>Math.abs(d))break;b-=d/(h+b*(2*j+3*r*b));c++}a=b;return a*(l+a*(s+a*t))}},bezier:function(a,b,d,e){return new this.Bezier(a,b,d,e)},easing:{ease:[0.25,0.1,0.25,1],linear:[0,0,1,1],easeIn:[0.42,0,1,1],easeOut:[0,0,0.58,1],easeInOut:[0.42,0,0.58,1]},getRequestAnimationFrame:function(){var a;
a=b.window.requestAnimationFrame;for(var c=0;c<e.length&&!a;c++)a=b.window[e[c]+"RequestAnimationFrame"];return a?a:function(a){var c,e,j;c=(new Date).getTime();e=Math.max(0,16-(c-d));j=b.window.setTimeout(function(){a(c+e)},e);d=c+e;return j}},getCancelAnimationFrame:function(){var a;a=b.window.cancelAnimationFrame;for(var c=0;c<e.length&&!a;c++)a=b.window[e[c]+"CancelAnimationFrame"]||b.window[e[c]+"CancelRequestAnimationFrame"];return a?a:function(a){b.window.clearTimeout(a)}},run:function(a,c,
d,e,h,j){function r(b){var e;if(!l)return l=+new Date,q(r);b=+new Date;e=b-l;b=s(e/d);e=13>d-e?!0:!1;b*=c-a;b=a+b;b=e?c:b;t&&h.call(this,b);if(e)p&&j.call(this,b);else return q(r)}var l,s,t=b.util.isFunction(h),p=b.util.isFunction(j),q=this.getRequestAnimationFrame();s="string"===typeof e&&this.easing[e]?this.bezier.apply(this,this.easing[e]):b.util.isArray(e)&&4===e.length?this.bezier.apply(this,e):this.bezier.apply(this,this.easing.ease);return q(r)}}})(lib);
