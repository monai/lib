...
(function(undefined){'use strict';(function(b,e){function d(){if(b.console&&b.console.log&&b.console.log.apply)b.console.log.apply(b.console,arguments);else{var a,c;d.output||(d.output=[]);c=arguments.length;for(a=Array(c);c--;)a[c]=arguments[c];a=a.join(", ");d.output.push(a);b.clearTimeout(d.timer);d.timer=b.setTimeout(function(){var a=d.output.join("\r\n");d.output=[];alert(a)},1E3)}return arguments[0]}var a,c;c=[];a={log:d,inspect:function(a){var c=[],e;for(e in a)Object.prototype.hasOwnProperty.call(a,e)&&c.push(e+
": "+a[e]);return c.join("\r\n")},window:b,document:b&&b.document,isReady:!1,ready:function(a){if(a===e){this.isReady=!0;for(var a=0,b=c.length;a<b;a++)c[a].call(this.window);c=[]}else"function"===typeof a&&(this.isReady?a.call(this.window):c.push(a))},extend:function(a){for(var c,e=0,b=arguments.length;++e<b;)for(c in arguments[e])arguments[e].hasOwnProperty(c)&&(a[c]=arguments[e][c]);return a},bind:function(a,c){return"bind"in a?a.bind(c):function(){return a.apply(c,arguments)}},guid:function(c){a.guid.id||
(a.guid.id=1);if(!c)return++a.guid.id;c.__guid||(c.__guid=a.guid.id++);return c.__guid}};b.lib=a;b.log=d})(window);
...
(function(b){b.object={keys:function(e){var b;if("keys"in Object)return Object.keys(e);b=[];for(var a in e)e.hasOwnProperty(a)&&b.push(a);return b},createFromTemplate:function(e,b){var b=b?b:{},a=e.split(".");(function f(a,e){a[e[0]]||(a[e[0]]={});1<e.length&&f(a[e[0]],e.splice(1))})(b,a);return b},subtract:function(e,b){var a={},c;for(c in e)"undefined"===typeof b[c]&&(a[c]=e[c]);return a}}})(lib);
(function(b){b.array={toArray:function(e){var b=[];try{b=Array.prototype.slice.call(e,0)}catch(a){for(var c=0,f=e.length;c<f;c++)b[c]=e[c]}return b},indexOf:function(e,d,a){a=a||0;if("indexOf"in Array.prototype)return Array.prototype.indexOf.call(e,d,a);for(var c=e.length;a<c;a++)if(b.util.isArray(d)?this.isEqual(e[a],d):e[a]===d)return a;return-1},lastIndexOf:function(e,d,a){a=a||e.length;if("lastIndexOf"in Array.prototype)return Array.prototype.lastIndexOf.call(e,d,a);for(a=e.length-1;0<=a;a--)if(b.util.isArray(d)?
this.isEqual(e[a],d):e[a]===d)return a;return-1},inArray:function(e,b){return-1<this.indexOf(e,b)?!0:!1},forEach:function(e,d,a){if("function"!==typeof d)throw new TypeError(d+" is not a function");if("forEach"in Array.prototype)Array.prototype.forEach.call(e,d,a||b.window);else for(var c=0,f=e.length;c<f;c++)d.call(a||b.window,e[c],c,e)},every:function(e,d,a){if("function"!==typeof d)throw new TypeError(d+" is not a function");if("every"in Array.prototype)return Array.prototype.every.call(e,d,a||
...
c-=1;for(a=f?a:e[c--];0<=c;c--)c in e&&(a=d.call(b.window,a,e[c],c,e));return a},isEqual:function(e){for(var b=!0,a=e.length,c=1,f=arguments.length;c<f;c++){if(a!==arguments[c].length)return!1;for(var g=0;g<a;g++)if(e[g]instanceof Array||arguments[c][g]instanceof Array)if(e[g]instanceof Array&&arguments[c][g]instanceof Array){if(b=this.isEqual(e[g],arguments[c][g]),!b)break}else return!1;else if(b=e[g]===arguments[c][g],!b)break;if(!b)break}return b},flatten:function(b){return this.reduce(b,function(b,
...
c=b.window.requestAnimationFrame;for(var e=0;e<d.length&&!c;e++)c=b.window[d[e]+"RequestAnimationFrame"];return c?c:function(c){var d,e,f;d=(new Date).getTime();e=Math.max(0,16-(d-a));f=b.window.setTimeout(function(){c(d+e)},e);a=d+e;return f}},getCancelAnimationFrame:function(){var a;a=b.window.cancelAnimationFrame;for(var e=0;e<d.length&&!a;e++)a=b.window[d[e]+"CancelAnimationFrame"]||b.window[d[e]+"CancelRequestAnimationFrame"];return a?a:function(a){b.window.clearTimeout(a)}},run:function(a,d,
