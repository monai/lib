...
(function(d,b){function c(a,e){this.thisConstructor=a;this.superConstructor=e}d.util={getType:function(a){var e,f;e=Object.prototype;f=e.toString.call(a);if(a===b)return"undefined";if(null===a)return"null";if(!0===a||!1===a)return"boolean";if("string"===typeof a)return"string";if("number"===typeof a)return"number";if("[object Arguments]"===f||e.hasOwnProperty.call(a,"callee"))return"Arguments";if("object"===typeof a)return this.getConstructorName(a)},isObject:function(a){return a===Object(a)},isArray:function(a){return"Array"===
this.getType(a)},isArguments:function(a){return"Arguments"===this.getType(a)},isFunction:function(a){return"Function"===this.getType(a)},isString:function(a){return"String"===this.getType(a)},isNumber:function(a){return"Number"===this.getType(a)},isDate:function(a){return"Date"===this.getType(a)},isRegExp:function(a){return"RegExp"===this.getType(a)},getFunctionName:function(a){return this.isFunction(a)&&/^function (\S+?)\(/m.test(a.toString())?RegExp.$1:b},getConstructorName:function(a){if(a&&a.constructor){var e,
a=a.thisConstructor||a.constructor;e=this.getFunctionName(a);e===b&&/\[object (\S+?)\]/.test(a.toString())&&(e=RegExp.$1);return e}return b},inherits:function(a,e){a.superConstructor=e;Object.create?a.prototype=Object.create(e.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0},superConstructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}):(c.prototype=e.prototype,a.prototype=new c(a,e))}}})(lib);
(function(d){function b(c,a){if(this===d.util)return new b(c,a);this.name=c;this.endTime=this.startTime=null;(a||"undefined"===typeof a)&&this.start()}d.extend(b.prototype,{start:function(){this.startTime=(new Date).getTime()},stop:function(){this.endTime=(new Date).getTime();return this.endTime-this.startTime},log:function(){var b=this.stop();d.log(this.name+": "+b+"ms")}});d.util.Benchmark=b})(lib);
